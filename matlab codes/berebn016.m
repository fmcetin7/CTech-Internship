...
for n = 1:50
    ...
    bpsk3noised = awgn (bpsk3symbols,snr);
    bpsk5noised = awgn (bpsk5symbols,snr);
    bpsk7noised = awgn (bpsk7symbols,snr);
    ...
    opsk3noised = awgn (opsk3symbols,snr);
    opsk5noised = awgn (opsk5symbols,snr);
    opsk7noised = awgn (opsk7symbols,snr);
    onoised = awgn(opsksymbols,snr);  

    snr = convertSNR(Ebno,"ebno",BitsPerSymbol=4);        
    spsk3noised = awgn (spsk3symbols,snr);
    spsk5noised = awgn (spsk5symbols,snr);
    spsk7noised = awgn (spsk7symbols,snr);
